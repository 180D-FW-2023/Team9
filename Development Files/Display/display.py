...
try:
    ...
    '''
    draw.line([(20,20),(40,20)], fill = 0)
    draw.line([(20,40),(40,40)], fill = 0)
    draw.line([(20,20),(20,40)], fill = 0)
    draw.line([(40,20),(40,40)], fill = 0)
    '''
    draw.text((0,0), '65 mph ', font = font1, fill = 0)
